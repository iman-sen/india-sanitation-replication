...
outreg2 using "$regs\table2.xls",  replace label stat(coef se) dec(3) noparen ctitle(1) sideway
...
outreg2 using "$regs\table2.xls", append  label stat(coef se) dec(3) noparen ctitle(2) sideway
