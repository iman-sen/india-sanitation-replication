 ** Code to recreate Appendix Table A1
...
putexcel set "$tables\tableA1.xlsx", replace
...
local states 9 22 24 19 2 6 20 23 33 8 36 27 18 5 10 21 29 28 3 32 
local row = 2
...
svy: mean INDICATOR1 if state_code ==`l' & year == 1
...
svy: mean INDICATOR1 if state_code ==`l' & year == 2
...
svy: mean INDICATOR1 if state_code ==`l' & year == 3
...
svy: mean INDICATOR1 if state_code ==`l' & year == 4
...
svy: mean INDICATOR1 if state_code ==`l' & year == 5
...
svy: mean INDICATOR1 if state_code ==`l' & year == 6
