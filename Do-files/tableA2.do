...
outreg2 using "$regs\tableA2.xls", replace label stat(coef se) dec(3) ctitle(All) 
...
outreg2 using "$regs\tableA2.xls",   append label stat(coef se) dec(3) ctitle(Wealth Quintile=1) 
...
outreg2 using "$regs\tableA2.xls",  append label stat(coef se) dec(3) ctitle(Wealth Quintile=2) 
...
outreg2 using "$regs\tableA2.xls",  append label stat(coef se) dec(3) ctitle(Wealth Quintile=3) 
...
outreg2 using "$regs\tableA2.xls", append label stat(coef se) dec(3) ctitle(Wealth Quintile=4) 
...
outreg2 using "$regs\tableA2.xls",  append label stat(coef se) dec(3) ctitle(Wealth Quintile=5)
