...
svy: mean INDICATOR1, over(year)
mat b1= (r(table)[1, 1..6]\ r(table)[5..6, 1..6])'

svy: mean INDICATOR4, over(year)
...
graph export "$figures\figure5panelA.png"  , replace
...
graph export "$figures\figure5panelB.png"  , replace