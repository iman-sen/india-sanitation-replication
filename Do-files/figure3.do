*============================================================
* Figure 3 — INDICATOR4 by subgroup, NFHS4 vs NFHS5 (rural)
...
graph export "$figures\figure3a.png", replace width(1800)
...
graph export "$figures\figure3b.png", replace width(1800)
...
graph export "$figures\figure3.png", replace width(2400)
